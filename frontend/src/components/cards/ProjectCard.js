...
const ProjectCard = () => {
  ...
  return (
    <Fragment>
    <div onClick={() => navigate('/project-details')} class="my-3 flex flex-col rounded-lg bg-white shadow-[0_2px_15px_-3px_rgba(0,0,0,0.07),0_10px_20px_-2px_rgba(0,0,0,0.04)] dark:bg-neutral-700 md:max-w-xl md:flex-row hover:shadow-lg hover:translate-y-[-4px]">
  <img
