...
const BlogCard = () => {
  return (
   <Fragment>
    ...
    <a href="#">
        <img  class="rounded-t-lg" src="https://images.pexels.com/photos/261579/pexels-photo-261579.jpeg?auto=compress&cs=tinysrgb&w=1600" alt="" />
    </a>
    <div class="p-4">
        <a href="#">
        ...
        <a href="/blog-details" class="inline-flex items-center px-3 py-2 text-sm font-medium text-center text-white bg-blue-700 rounded-lg hover:bg-blue-800 focus:ring-4 focus:outline-none focus:ring-blue-300 dark:bg-blue-600 dark:hover:bg-blue-700 dark:focus:ring-blue-800">
            Read more
