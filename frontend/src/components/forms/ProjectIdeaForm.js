...
const ProjectIdeaForm = ({isEditForm,handleSendForm,firstname,setFirstname,lastname,setLastname,email,setEmail,phoneNumber,setPhoneNumber,projectIdea,setProjectIdea}) => {
